...
def routes(request):
    origin = models.ForeignKey(
        Airport, on_delete=models.CASCADE, related_name="depature")
    destination = models.ForeignKey(
        Airport, on_delete=models.CASCADE, related_name="destination")
    stopover = models.ManyToManyField(
        flights, blank=True, related_name="stopover")
...
class flights(models.Model):
    ...
    destination = models.ForeignKey(
        Airport, on_delete=models.CASCADE, related_name="arraivals")
...
class Passenger(models.Model):
    ...
    flights = models.ManyToManyField(
        flights, blank=True, related_name="passenger")
